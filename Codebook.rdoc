...
For the tidy data, you can find information about output variables and its data types. A full description of the code 
for the run_analysis.R script and what it does, will be included en the "How the run_analisys script works?" section. 
...
* fBodAccMagFreq
* fBodBodAccJerkMag
* fBodBodAccJerkMagFreq
* fBodBodGyroMag
* fBodBodGyroMagFreq
* fBodBodGyroJerkMag
* fBodBodGyroJerkMagFreq

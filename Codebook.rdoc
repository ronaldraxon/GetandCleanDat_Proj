...
-Even the subject number goes up yo 30 there's only 21 subjects
-The quantity of observations per each activity is not the same for all subjects. In other words if there are four observations 
for any subject in "WALKING" activity there are more o less than four observations in other activities.

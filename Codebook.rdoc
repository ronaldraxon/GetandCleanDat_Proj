...
It uses the detach() function to discard the called library plyr. It has to be done in order to use summarise_each() function
(if not the result will be a sigle row)
